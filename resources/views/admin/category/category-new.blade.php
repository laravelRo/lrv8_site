...
@section('content')
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Adauga categorie</li>
    </ol>
        ...
        <form action="{{ route('admin.categories.add') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input name="title" type="text" class="form-control @error('title') is-invalid @enderror " id="title"
                        placeholder="Numele noii categorii" value="{{ old('title') }}">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input name="slug" type="text" class="form-control @error('slug') is-invalid @enderror " id="slug"
                        placeholder="Adresa paginii tip slug" value="{{ old('slug') }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="subtitle" type="text" class="form-control @error('subtitle') is-invalid @enderror "
                        id="subtitle" placeholder="Subtitlul noii categorii" value="{{ old('subtitle') }}">
                ...
                <div class="form-group col-md-8">
                    ...
                    <textarea name="excerpt" class="form-control @error('excerpt') is-invalid @enderror " id="excerpt"
                        placeholder="Descrierea paginii categoriei"></textarea>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input name="position" type="number" class="form-control @error('position') is-invalid @enderror "
                        id="position" placeholder="Ordinea de afisare" value="{{ old('position') }}">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <div id="img-preview">
                        <img id="photo-preview" src="/images/categories/category.jpg" alt="no photo"
            ...
            <div class="form-row bg-light my-4">
                <div class="form-group col-md-4">
                    ...
                    <input name="meta_title" type="text" class="form-control @error('meta_title') is-invalid @enderror "
                        id="meta_title" placeholder="Tagul meta title al categoriei" value="{{ old('meta_title') }}">
            ...
            <button type="submit" class="btn btn-primary float-right ml-4">Adauga categorie</button>
